# -*- coding: utf-8 -*-
'''
本模块支持2BPP 4BPP 8BPP RGBA4444,RGBA5551,RGB565,RGBA8888,DXT1,DXT3,DXT5相关解析
...
def paint_4BPP(width,height,tile_w,tile_h,data_buff,paletteData,Endian_type,platform_type):
    ...
    for char in nPixel_data:
        datalist.append(paletteData[char])
    return datalist
def paint8BPP(width,height,tile_w,tile_h,data_buff,paletteData,paletteType,pal_tx , pal_ty,platform_type):
    #width 图片宽度
    #height 图片高度
    #tile_w tile宽度
    #tile_h tile高度
